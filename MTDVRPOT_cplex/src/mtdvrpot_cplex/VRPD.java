...
public class VRPD {
   ...
   // public int nombre_nouveaux_clients;
    ...
    public void setOvetime_dynamic(double ovetime_dynamic) {
     ...
     public VRPD( VRP_total VRPT,ArrayList<Customer> customers, ArrayList<Depotfictif> depot_fictifs, Depotcentral depot, double maxTemps, int nombrecamions, double capacitycamion,  double overtime, double temps_service) {
